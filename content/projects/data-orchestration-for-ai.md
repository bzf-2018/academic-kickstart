...
{{< figure_video src="projects/data-orchestration-for-ai/overview.png" library="1" >}}

---

## Topic 1: Agentic Data Orchestration for Scholarly Corpora

**1.1) AgenticScholar: Agentic Data Management with Pipeline Orchestration for Scholarly Corpora ([SIGMOD'26](https://arxiv.org/pdf/2603.13774)) ([System Prototype](https://agenticscholar.github.io))**

{{< modality_badges "text" "table" "image" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/agenticscholar.png" youtube_id="rRzr36fhqHQ" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/robin.png" youtube_id="3VVcH1wyvK4" library="1" >}}

---

**2.2) Beyond Retrieval: Multi-Hop Table Synthesis in Data Lakes (*under review*) (WWW'25 Demo)**

{{< modality_badges "text" "table" >}}

Autonomous data agents rely on accurate data retrieval to satisfy the data requirements expressed in users’ natural-language queries. However, most existing work focuses on single-table retrieval, largely mirroring text-retrieval pipelines and treating each table independently. This design neglects inter-table relationships (e.g., joinability and unionability) that often must be leveraged jointly to answer complex queries, ultimately leaving the downstream LLM with a structurally fragmented and non-joinable context. To address this gap, we study a novel problem setting termed Intent-Driven Multi-Hop Table Synthesis. In this setting, the objective shifts from retrieving independent tables to dynamically discovering a cohesive, interconnected subgraph of tables that collectively satisfies the user’s overarching analytical intent. To solve this problem, we propose IDSSI, a comprehensive framework for intent-driven synthesis sequence identification. By jointly optimizing semantic relevance and structural coverage, and leveraging a suite of multi-level search optimizations, IDSSI accurately synthesizes executable tabular contexts while maintaining high efficiency and scalability over enterprise-scale data lakes.

{{< figure_video src="projects/data-orchestration-for-ai/idssi.png" width="700" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/unidisc.png" library="1" >}}
...
{{< modality_badges "image" "table" "time series" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/fcm.png" youtube_id="X77dBDs17Qg" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/dm1.png" youtube_id="WzaEn8e9jhQ" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/daml.png" youtube_id="19khiFs3elA" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/rtsd.png" youtube_id="Az89QXhxP58" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/salto.png" youtube_id="uOx-kdsJACE" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/alore.png" width="600" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/cesid.png" youtube_id="3I-A8s6V90E" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/semibonsai.png" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/dmral.png" youtube_id="QNUCJe6PImo" library="1" >}}
...
{{< figure_video src="projects/data-orchestration-for-ai/visformer.png" library="1" >}}
